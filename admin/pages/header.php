    ...
    <body>
        ...
        ?></a>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li>   
                                <a href="?action=logout" onclick="return confirm('Bạn có chắc chắn muốn đăng xuất?');"><i class="fa fa-sign-out fa-fw"></i> Đăng xuất</a>
                            </li>       
                        </ul>
                    </li>
                </ul>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="revenue.php"><i class="fa fa-bar-chart"></i> Báo cáo doanh thu</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            $(document).ready(function() {
                ...
                // Kích hoạt metisMenu cho sidebar
                $('#side-menu').metisMenu();
            });
            </script>
        </div>
