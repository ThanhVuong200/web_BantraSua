<?php
session_start();
$pageTitle = "THANH TOÁN | Company Coffee - Cà Hê Ngon";
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered" id="cart-summary">
                            ...
                            <tbody>
                                ...
                                <?php 
                                $sId = session_id();
                                $danhsach = mysqli_query($conn, "SELECT g.*, ps.size, ps.giaSanPham, ps.soLuongSanPham AS stock 
                                                                FROM tbl_giohang g 
                                ...
                                <tr>
                                    ...
                                    <td class="cart-description">
                                        ...
                                        <small><a href="#">Size: <?php echo $rows['size']; ?></a></small>
                                    </td>
                                    ...
                                    <td class="cart_quantity text-center">
                                        <span><?php echo $rows['soLuongSanPham']; ?></span>
                                    </td>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered delivery-table">
                                            <tr>
                                                ...
                                                <td class="carrey-cost">Vui lòng thanh toán với shipper khi nhận hàng.</td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="table table-bordered delivery-table">
                                            <tr>
                                                <td class="delivery-option-radio">
                                                    <div class="dalivery-radio">
                                                        <span class="radio-box">
                                                            <input type="radio" value="2" name="deliverymethod" onchange="showImage(this)">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td class="delivery-method-icon">
                                                ...
                                                <td class="carrey-cost">
                                                    <img id="payment-qr-code" src="img/QR.png" alt="" style="display: none;">
                                                </td>
                                            </tr>
                                        </table>
                                        <!-- PRODUCT-DELIVERY SINGLE OPTION END -->
